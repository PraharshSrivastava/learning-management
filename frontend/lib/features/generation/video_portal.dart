...
class _VideoViewState extends ConsumerState<VideoView> {
  ...
  Widget _buildVideoDetailPane() {
    if (_selectedModuleIndex == null) {
      return const Center(
          child: Text('Select a module to view video details.'));
    }
        ...
        Container(
          ...
          child: LayoutBuilder(
            builder: (context, constraints) {
              ...
              final actions =
                  _buildVideoActions(module, videoUrl, videoFilename);
                    ...
                    Expanded(
                      child: Container(
                        ...
                        child: HlsVideoPlayer(
                          hlsUrl:
                              AppConstants.hlsVideoAssetUrl(module.videoPath!),
        ...
        child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Expanded(
              child: Column(
                ...
                Text(notes,
                    style:
                        GoogleFonts.barlow(color: AppTheme.gray, height: 1.45)),
              ])),
        ]),
      );
  ...
  Widget _buildVideoActions(
      CourseModule module, String videoUrl, String videoFilename) {
    return Wrap(
      spacing: 8,
      runSpacing: 8,
