      ...
      child: Wrap(
        ...
        children: [
          _FilterDropdown(
            ...
            items: {
              for (final course in dashboard.options.courses)
          ...
          _FilterDropdown(
            ...
            items: {
              for (final department in dashboard.options.departments)
          ...
          _FilterDropdown(
            ...
            value: filter.status,
            items: {
              for (final status in dashboard.options.statuses)
          ...
          OutlinedButton.icon(
            onPressed: () =>
                ref.read(performanceProvider.notifier).clearFilters(),
...
class _SummaryGrid extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final cards = [
      ...
      _Metric('Avg attempts', summary.averageAttempts.toStringAsFixed(1),
    ...
    return _Panel(
      child: Column(
        ...
        children: [
          ...
          if (rows.isEmpty)
            const SizedBox(
                height: 180, child: Center(child: Text('No matching records')))
          else
      ...
      child: ExpansionTile(
        ...
        title: Wrap(
          ...
          children: [
            ...
            _Cell(
                width: 130, top: _shortDate(row.deadline), bottom: 'Due date'),
          ],
        ),
        children: [
