...
class _CourseDetailsViewState extends ConsumerState<CourseDetailsView> {
  ...
  void _initControllers() {
    ...
    _descController =
        TextEditingController(text: widget.course.courseDescription);
    _objController = TextEditingController(text: widget.course.courseObjective);
    _audienceController =
        TextEditingController(text: widget.course.targetAudience);
    ...
    if (['easy', 'medium', 'hard'].contains(diff.toLowerCase())) {
      _selectedDifficulty =
          diff[0].toUpperCase() + diff.substring(1).toLowerCase();
                  ...
                  children: [
                    ...
                    ReorderableListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        return Container(
                          key: ValueKey(
                              'module_key_${index}_${_moduleData[index].moduleNumber}'),
                            ...
                            children: [
                                  ...
                                  IconButton(
                                    ...
                                    onPressed: () {
                                      setState(() {
                                        ...
                                        _moduleQuestionsControllers[index]
                                            .dispose();
                              ...
                              TextFormField(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  hintText:
                                      'Module content will appear here after generation...',
                    ...
                    if (widget.course.images.isEmpty)
                      ...
                      GridView.builder(
                        ...
                        itemBuilder: (context, idx) {
                          ...
                          final mappedModuleNumber =
                              _moduleNumberForImage(img.imageId);
                          return Container(
                            decoration: BoxDecoration(
                              color: Colors.white,
                              borderRadius: BorderRadius.circular(8),
  ...
  String _videoDownloadFilename(CourseModule module) {
    final rawTitle =
        module.title.trim().isEmpty ? 'module' : module.title.trim();
