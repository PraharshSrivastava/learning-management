...
class AssignmentGroup {
  ...
  factory AssignmentGroup.fromJson(Map<String, dynamic> json) {
    ...
    return AssignmentGroup(
      ...
      roles: strings('roles'),
      joinedLessThanDaysAgo: (json['joined_less_than_days_ago'] as num?)?.toInt(),
    );
  }
  ...
  factory AssignmentOptions.fromJson(Map<String, dynamic> json) {
    return AssignmentOptions(
      employees: (json['employees'] as List? ?? [])
          ...
          .toList(),
      departments:
          (json['departments'] as List? ?? []).map((item) => item.toString()).toList(),
...
class PerformanceCourseOption {
  ...
  const PerformanceCourseOption({required this.id, required this.title});
  ...
  factory PerformanceOptions.fromJson(Map<String, dynamic> json) {
    return PerformanceOptions(
      ...
      courses: (json['courses'] as List? ?? [])
          .map((item) => PerformanceCourseOption.fromJson(item as Map<String, dynamic>))
          .toList(),
      statuses: (json['statuses'] as List? ?? [])
          .map((item) => PerformanceStatusOption.fromJson(item as Map<String, dynamic>))
          .toList(),
    );
  }
}
  ...
  factory PerformanceRow.fromJson(Map<String, dynamic> json) {
    ...
    return PerformanceRow(
      ...
      modules: (json['modules'] as List? ?? [])
          .map((item) => PerformanceModule.fromJson(item as Map<String, dynamic>))
          .toList(),
    );
  }
}
...
class PerformanceDashboard {
  ...
  final List<PerformanceBreakdown> roleBreakdowns;
  ...
  factory PerformanceDashboard.fromJson(Map<String, dynamic> json) {
    ...
    List<PerformanceBreakdown> breakdownList(String key) =>
        (breakdowns[key] as List? ?? [])
            .map((item) => PerformanceBreakdown.fromJson(item as Map<String, dynamic>))
            .toList();
    return PerformanceDashboard(
      ...
      roleBreakdowns: breakdownList('roles'),
