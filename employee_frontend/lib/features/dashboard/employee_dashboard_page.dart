...
import 'package:employee_frontend/data/models/course_dashboard_data.dart';
...
import 'package:employee_frontend/features/learning/course_playback_page.dart';
...
class _EmployeeDashboardPageState extends ConsumerState<EmployeeDashboardPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final openCourse = _openCourseId == null
        ...
        : courses.cast<Course?>().firstWhere(
              (course) => course?.courseId == _openCourseId,
              orElse: () => null,
            );
    ...
    final unreadCourses = courses
        .where((course) =>
            ...
            !_seenNotifications.contains(course.courseId))
        .toList();
  ...
  void _showCourseAction(Course course) {
    setState(() => _openCourseId = course.courseId);
  }
                    ...
                    SizedBox(
                      ...
                      child: Text(
                        course.courseDescription.isEmpty
                            ? 'Structured learning designed for your job title.'
...
class _CourseThumbnail extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final imagePath = course.thumbnailPath.isNotEmpty
