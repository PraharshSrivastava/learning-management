...
class _EmployeeLoginPageState extends ConsumerState<EmployeeLoginPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final employees = auth.employees.where((employee) {
      final haystack =
          '${employee.name} ${employee.employeeCode} ${employee.email} ${employee.department} ${employee.role}'
              .toLowerCase();
      final matchesQuery = _query.isEmpty || haystack.contains(_query.toLowerCase());
                    ...
                    children: [
                      ...
                      IconButton(
                        onPressed: auth.isLoading
                            ? null
                            : () => ref.read(demoAuthProvider.notifier).fetchEmployees(),
                          ...
                          Expanded(
                            child: TextField(
                              ...
                              decoration: const InputDecoration(
                                ...
                                hintText: 'Search by name, code, email, department, or role',
                                ...
                                builder: (context, constraints) {
                                  final columns = constraints.maxWidth >= 1040
                                      ...
                                      : constraints.maxWidth >= 680
                                          ? 2
                                          : 1;
                                  final cardHeight = constraints.maxWidth >= 680 ? 210.0 : 220.0;
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 14),
              _MetaLine(icon: Icons.apartment_outlined, text: employee.department),
              const SizedBox(height: 7),
              _MetaLine(icon: Icons.badge_outlined, text: employee.role),
              const SizedBox(height: 7),
              _MetaLine(
