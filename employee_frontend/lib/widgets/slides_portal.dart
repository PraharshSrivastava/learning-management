...
class _SlidesViewState extends ConsumerState<SlidesView> {
                ...
                child: Consumer(
                  builder: (context, ref, child) {
                    ...
                    return Text(
                      ...
                      style: GoogleFonts.barlow(color: Colors.white70, fontSize: 14, fontWeight: FontWeight.w600),
                    );
                  },
                ),
              ),
  ...
  Widget build(BuildContext context) {
          ...
          child: Column(
            ...
            children: [
              ...
              if (slideGenState.status == SlideGenStatus.generating) ...[
                ...
                const SizedBox(height: 12),
                Text(
                  'Slicing lessons and planning slide layouts...',
                  style: GoogleFonts.barlow(
                    fontSize: 13,
                    color: AppTheme.primaryBlue,
                ...
                ElevatedButton.icon(
                  ...
                  onPressed: () async {
                    final success = await ref
                        ...
                        .generateSlides(widget.course.id, ref);
                    if (success && context.mounted) {
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(
                          content: Text('Visual slides generated successfully!'),
    ...
    final String viewId = 'slide-viewer-${widget.course.id}-${module.moduleNumber}';
    final String slideUrl = AppConstants.slideshowHtmlUrl(widget.course.id, module.moduleNumber);
                    ...
                    Row(
                      children: [
                        ElevatedButton.icon(
                          ...
                          onPressed: () {
                            ref.read(currentTabProvider.notifier).state = 4; // Navigate to Scripts tab
                          },
                        ),
                        ...
                        ElevatedButton.icon(
                          ...
                          onPressed: () => _enterFullscreen(viewId, slideUrl, module),
                        ),
                      ],
                    ),
                  ],
